...
device = Device.create!({:app_key => "qrhj0fzeVR1", :app_secret => "MAaJDHu2l9", :master_key => "78ed9c4ca8c14c81b7ee86516cc9817e", :product_id => 15103201, :device_id => "1a58b602c2de43d1b8b01a8b9673c60a"})
